...
<section class="contact_us section-padding">
  <div class="container">
    <div  class="row">
      ...
      <div class="col-md-6">
        <h3>Contact Info</h3>
We provide a wide range of vehicle types and prices. We make car rentals easier for you. From budget to luxury. You will be able to find cars for all occassions.
        <?php }} ?>
        </div>
      </div>
    </div>
